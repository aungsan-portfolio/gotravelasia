 ...
 * @description Price Alerts modal — production-safe final
              ...
              <div className="grid grid-cols-1 gap-2.5 mb-2" role="radiogroup" aria-label="Select a flight route">
                {WATCH_ROUTES.map((route) => (
                  <button
                    ...
                    className={`w-full min-h-[46px] text-left px-4 tracking-wide rounded-xl border transition-all text-[13px] font-semibold ${
